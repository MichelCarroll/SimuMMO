...
declare function clearTimeout(timeoutId: Timer):any;
declare function setInterval(callback: (...args: any[]) => void, ms: number, ...args: any[]): Timer;
declare function clearInterval(intervalId: Timer):any;
...
declare class NodeProcess extends EventEmitter {
    ...
    arch: string;
    platform: string;
    memoryUsage(): { rss: number; heapTotal:any; number:any; heapUsed: number; };
...
declare module "stream" {
    ...
    export class Readable extends events.EventEmitter {
        ...
        resume(): void;
        destroy(): void;
        push(chunk:any, encoding?:any): void;
